...
function Home({ setUserDatas }) {
  ...
  useEffect(() => { setUserDatas(() => { return userData }) })

  return (
    <>
      <motion.section initial={{ transform: "translate(100%, 0)" }} animate={{ transform: "translate(0%, 0)" }} transition={{ duration: 1 }} className="home">
        <section className="reserve">
          ...
          <form action="" onSubmit={handleSubmit}>
            ...
            <button type="submit" id="checkAvail">Check Available</button>
          </form>
        </section>
